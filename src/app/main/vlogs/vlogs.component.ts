...
import { ConfirmVlogsDialogComponent } from './confirm-vlogs-dialog/confirm-vlogs-dialog.component';
...
export class VlogsComponent implements AfterViewInit {
  selectedRowIndex = -1;
  ...
  constructor(private db: VLogsServices, public dialog: MatDialog, public snackBar: MatSnackBar) { }
  ...
  deleteHostDialog( data ): void {
      ...
      const dialogRef = this.dialog.open( ConfirmVlogsDialogComponent, {
        width: '350px',
        data: data
      });
